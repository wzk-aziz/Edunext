...
//import { CoursesBackComponent } from './courses/courses-back.component';

// Virtual Classroom & Tutoring Admin
import { SessionComponent } from './VirtualClassroom-Admin/session/session.component';
import { MentorshipPorgramComponent } from './Tutoring-Admin/mentorship-porgram/mentorship-porgram.component';
import { ChatMessageComponent } from './VirtualClassroom-Admin/chat-message/chat-message.component';
import { FeedBackComponent } from './VirtualClassroom-Admin/feed-back/feed-back.component';
...
const routes: Routes = [
  {
    ...
    children: [
     ...
     // { path: 'courses', component: CoursesBackComponent },
      ...
      // Fallback route for back office - always keep this last
