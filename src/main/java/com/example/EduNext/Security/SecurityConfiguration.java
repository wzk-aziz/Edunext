    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/auth/**", "/api/v1/users/**","/api/exams/**" ,"/forgotPassword/**","/api/customer/**","/api/admin/**","/api/admin/coupons/**","/api/donations/**","/api/payments/**","/api/blog/**","/api/event/**","/api/forum/**","/api/reaction/**","/api/reservation/**","/api/thread/**").permitAll()
