...
import com.example.exam_service.dto.ExamSubmissionDTO;
...
public class ExamService {
    ...
    public int submitExam(int examId, Map<Long, String> userAnswers) {
        ...
        for (Question question : exam.getQuestions()) {
            ...
            System.out.println("CourseQuestion ID: " + question.getId() + ", Réponse correcte: " + correctAnswer + ", Réponse de l'utilisateur: " + userAnswer);
