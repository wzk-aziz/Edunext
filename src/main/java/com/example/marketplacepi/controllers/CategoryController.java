...
public class CategoryController {
    ...
    public ResponseEntity<Category> createCategory(@RequestBody CategoryDto categoryDto) {
        ...
        log.info("CourseCategory created with ID: {}", category.getId());
    ...
    public ResponseEntity<Category> getCategoryById(@PathVariable Long categoryId) {
        ...
        if (category != null) {
            log.info("CourseCategory with ID: {} found", categoryId);
            return ResponseEntity.ok(category);
        } else {
            log.warn("CourseCategory with ID: {} not found", categoryId);
    ...
    public ResponseEntity<Void> deleteCategory(@PathVariable Long categoryId) {
        ...
        if (deleted) {
            log.info("CourseCategory with ID: {} deleted successfully", categoryId);
    ...
    public ResponseEntity<Category> updateCategory(@PathVariable Long categoryId, @RequestBody CategoryDto categoryDto) {
        ...
        if (updatedCategory != null) {
            log.info("CourseCategory with ID: {} updated successfully", categoryId);
